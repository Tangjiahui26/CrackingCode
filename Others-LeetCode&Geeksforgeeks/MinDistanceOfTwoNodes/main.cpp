...
// parent pointers are given. Distance between two nodes
// is th minimum number of edges to be traversed to reach
// one node from other.

// Solution: we can first find lowest common Ancestor of two nodes.
